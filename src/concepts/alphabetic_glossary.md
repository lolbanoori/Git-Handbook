...
- **Code reviews**: The deliberate and methodical gathering of other programmers to examine each other's code for errors to increase the code quality and reduce the number of bugs.
...
- **SHA-1**: A cryptographic hash function used by Git to uniquely identify commits and content.
